...
import in.mjunth.resumebuilderjava.service.EmailService;
...
public class EmailController {
    ...
    public ResponseEntity<Map<String,Object>> sendResume(@RequestPart("recipientEmail") String recipientEmail,
        ...
        String emailBody = Objects.nonNull(body)?body:"Please find my resume";

        emailService.sendEmailWithAttachment(recipientEmail,emailSubject,emailBody,bytes,filename);
